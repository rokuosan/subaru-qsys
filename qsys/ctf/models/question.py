...
class Question(models.Model, ExportModelOperationsMixin("question")):
    """CTF 問題"""
    id = models.UUIDField(primary_key=True, help_text="問題ID", default=uuid.uuid4, editable=False)
    ...
    category = models.ForeignKey(
        "Category", on_delete=models.SET_DEFAULT, help_text="カテゴリ", default="Uncategorized"
    )
    difficulty = models.ForeignKey(
        "Difficulty", on_delete=models.SET_DEFAULT, help_text="難易度", default="Easy"
    )
    is_open = models.BooleanField(
        help_text="公開中かどうか", default=True
    )
